...
public class card extends javax.swing.JPanel {
    ...
    public card(String nombre, String deuda) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(175, 191, 144));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 170, 10));

        jLabel13.setBackground(new java.awt.Color(0, 0, 0));
        jLabel13.setForeground(new java.awt.Color(0, 0, 0));
        jLabel13.setText("Deuda");
        jLabel13.setPreferredSize(new java.awt.Dimension(119, 40));
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 150, 20));

        jLabel14.setBackground(new java.awt.Color(0, 0, 0));
        jLabel14.setForeground(new java.awt.Color(0, 0, 0));
        jLabel14.setText("Nombre: ");
        jLabel14.setPreferredSize(new java.awt.Dimension(119, 40));
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 150, 20));
        ...
        jPanel1.add(deuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 150, 20));

        name.setBackground(new java.awt.Color(0, 0, 0));
        name.setForeground(new java.awt.Color(0, 0, 0));
        name.setText("Nombre");
        name.setPreferredSize(new java.awt.Dimension(119, 40));
        jPanel1.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 150, 20));
